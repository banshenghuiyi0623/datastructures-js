...
describe('doublyLinkedList tests', function() {
    ...
    describe('.length()', () => {
        it('should get the length of the list', () => {
            expect(doublyLinkedList.getLength()).to.equal(8);
        });
    });
    ...
    describe('.removeFirst()', () => {
        it('should remove the first node', () => {
            ...
            expect(doublyLinkedList.getLength()).to.equal(7);
    ...
    describe('.removeLast()', () => {
        it('should remove the last node', () => {
            ...
            expect(doublyLinkedList.getLength()).to.equal(6);
    ...
    describe('.remove(value)', () => {
        it('should remove a node', () => {
            ...
            expect(doublyLinkedList.getLength()).to.equal(5);
